                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-12">
                                    <div class="cart-totals margin-b-20">
                                        ...
                                        <div class="cart-totals-fields">
											...
											<tbody>
                                                    ...
                                                    <tr>
                                                        <td>Subtotal do carrrinho</td>
                                                        <td> <?php echo "Kzs".$item_total; ?></td>
                                                    </tr>
                                                    <tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-color"><strong> <?php echo "Kzs".$item_total; ?></strong></td>
                                                    </tr>
                                                </tbody>
                                    ...
                                    <div class="payment-option">
                                        ...
                                        <p class="text-xs-center"> <input type="submit" onclick="return confirm('Você quer confirmar o pedido?');" name="submit"  class="btn btn-success btn-block" value="Finalizar a compra"> </p>
                                    </div>
									</form>
                                </div>
                            </div>
