        ...
        <header id="header" class="header-scroll top-header headrom">
            <nav class="navbar navbar-dark">
                <div class="container">
                    ...
                    <a class="navbar-brand" href="index.php"> <img class="img-rounded" src="images/KENTASSO.png" alt="" height="47px" width="98px"><i style="font-size: 20px;">KENTASSO/SPACE</i>  </a>
                    <div class="collapse navbar-toggleable-md  float-lg-right" id="mainNavbarCollapse">
                        <ul class="nav navbar-nav">
                            <li class="nav-item"> <a class="nav-link active" href="index.php">Home <span class="sr-only">(current)</span></a> </li>
                            <li class="nav-item"> <a class="nav-link active" href="about_kentasso.php">Sobre o Kentasso <span class="sr-only">(current)</span></a> </li>
                            <li class="nav-item"> <a class="nav-link active" href="restaurants.php">A melhor escolha <span class="sr-only"></span></a> </li>
        ...
        <section class="hero bg-image" data-image-src="images/img/pimg.jpg">
            <div class="hero-inner">
                <div class="container text-center hero-text font-white">
                    <h1>No Kentasso o cliente sai com um sorriso no rosto </h1>
                    ...
                    <div class="steps">
                        <div class="step-item step1">
                            ...
                            <h4><span style="color:white;">1. </span>Escolhe o melhor Restaurante</h4> </div>
                        ...
                        <div class="step-item step2">
                            ...
                            <h4><span style="color:white;">2. </span>Melhor atendimento</h4> </div>
                        ...
                        <div class="step-item step3">
                            ...
                            <h4><span style="color:white;">3. </span>Com a melhor Entrega</h4> </div>
        ...
        <section class="popular">
            <div class="container">
                <div class="title text-xs-center m-b-30">
                    <h2>Pratos que te deixam com água na boca</h2>
                    <p class="lead">Nós temos os melhores chefes da cozinha no Kentasso/Space</p>
                </div>
                <div class="row">
						<?php 					
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-sm-12 text-center">
                        <p class="pay-info">Pagamento na entrega ou por transferência</p>
                    </div>
                </div>
            </div>
        </section>
                ...
                <div class="bottom-footer">
                    <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-4 address color-gray">
                                    <h5>Endereço</h5>
                                    <p>Luanda, Viana-Zango 3, Rua da Rira</p>
                                    <h5>Tel: 999999999</a></h5> </div>
                                <div class="col-xs-12 col-sm-5 additional-info color-gray">
                                    <h5>Dica do dia no KENTASSO/SPACE</h5>
                                   <p style="position: absolute;">"No Kentasso, oferecemos dos melhores pratos da região, 
                                    com uma variedade incrível que agrada a todos os paladares. Nossas bebidas, cuidadosamente selecionadas, 
                                    complementam perfeitamente cada refeição. E entre o Kentasso e o Paraíso, sinceramente, não vejo muita diferença. Ambos oferecem uma experiência gastronômica excepcional, 
                                    com um ambiente acolhedor e um atendimento de qualidade. Venha nos visitar e descubra por si mesmo!"</p>
                                </div>
                    </div>
                </div>
